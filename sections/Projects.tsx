    ...
    <Section id="projects">
      ...
      >
        ...
        >
          ...
          сосредоточенным на своей цели до тех пор, пока проект не завершен и не
          будет удовлетворять моим требованиям и требованиям заказчика. Усердие
          и стремление выполнять работу качественно делают меня ценным активом
          для любой команды.
        </motion.p>
        <div className="flex w-full gap-3 overflow-x-scroll py-5 scrollbar-hide xl:grid xl:grid-cols-3 xl:gap-8 xl:px-[2px]">
